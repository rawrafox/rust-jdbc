...
impl ResultSetMetaData {
  pub fn get_catalog_name(&self, column: i32) -> java::Result<Option<std::string::String>> {
    return jvm_call!(string: self, "getCatalogName", "(I)Ljava/lang/String;", &[&column.to_value()]);
  }

  pub fn get_column_class_name(&self, column: i32) -> java::Result<Option<std::string::String>> {
